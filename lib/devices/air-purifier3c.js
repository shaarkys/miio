...
module.exports = class extends AirPurifier
	.with(MiioApi, Power, Mode, AQI, SwitchableLED, LEDBrightness, Buzzer)
{
	...
	get serviceMapping() {
		return {
			...
			aqi: { siid: 3, piid: 4 },
			favorite_level: { // favorite level is not supported on the 3C
				siid: 10, 
				piid: 10,
				mapping: (level) => {
			...
			filter1_life: { siid: 4, piid: 1 },
			f1_hour_used: { siid: 4, piid: 3 },
